...
proc pBooleanTypeDisplay {switch_num} {
	...
	"1" {
	    ...
	    } elseif {"$boolSwitch1" == "[lindex $boolList 4]"} {
		set boolSwitch1 [lindex $boolList 0]
	    } else {
		set boolSwitch1 [lindex $boolList 4]
	    }
	}
	"2" {
	    if {"$boolSwitch2" == "[lindex $boolList 2]"} {
		set boolSwitch2 [lindex $boolList 3]
	    } elseif {"$boolSwitch2" == "[lindex $boolList 5]"} {
		set boolSwitch2 [lindex $boolList 2]
	    } else {
		set boolSwitch2 [lindex $boolList 5]
	    }
	...
	"3" {
	    ...
	    } elseif {"$boolSwitch3" == "[lindex $boolList 4]"} {
		set boolSwitch3 [lindex $boolList 0]
	    } else {
		set boolSwitch3 [lindex $boolList 4]
	    }
	}
    }
}
