...
#
# This version is for smaller screens...
#
global CITIES
set current_full_display 0
set dtdname ../doc/install/TREC.FT.DTD
set textresults {}

map .map -mapfile MAPDATA/map.data -bg black -width 8i  -height 5i -detail 3 -aspect 110
pack .map -side top
...
proc make_searchlist {top bot} {
	...
	set results [eval zfind country @ $searchkey]
	#puts $results
