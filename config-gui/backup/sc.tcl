...
namespace eval staffcheshire {
	...
	.fdbcfg.dbcfgfr.gridwin.data.datafr.dummyfr2 59 \
	.fdbcfg.dbcfgfr.gridwin.data.canvas.frame 60 \
	.fdbcfg.dbcfgfr.gridwin.indexes 61 \
...
proc staffcheshire {{base .staffcheshire} args} {
	...
	rtl_tabset $base$w(300) -autovisible "1" -borderspace "10"\
		...
		-show "data indexes clusters display component explain"\
	...
	rtl_gridwin $base$w(14) -activebackground "lightgray" -auto "1"\
		-fill "both" -height "500" -highlightbackground "lightgray"\
	...
	grid $base$w(30) -column 0 -row 0 -padx 30 -pady 15 -sticky ew;
	grid $base$w(18) -column 0 -row 1 -padx 30 -pady 15 -sticky ew;
	grid $base$w(33) -column 0 -row 2 -padx 30 -pady 15 -sticky nesw;
	grid $base$w(36) -column 0 -row 3 -padx 30 -pady 15 -sticky ew;
	grid $base$w(40) -column 0 -row 4 -padx 30 -pady 15 -sticky ew;
	grid $base$w(44) -column 0 -row 5 -padx 30 -pady 15 -sticky ew;
	grid $base$w(47) -column 0 -row 6 -padx 30 -pady 15 -sticky ew;
	grid $base$w(51) -column 0 -row 7 -padx 30 -pady 15 -sticky ew;
	grid $base$w(55) -column 0 -row 8 -padx 30 -pady 15 -sticky ew;
	grid $base$w(58) -column 0 -row 9 -sticky nesw;

	# Grid (size:1 10) $base$w(17) = datafr
	...
	pack $base$w(13) -expand 1 -fill both;
