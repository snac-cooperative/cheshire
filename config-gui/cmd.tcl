...
namespace eval cmd {
	...
	.cmdtabset.build.buildfpfr.buildassocfpBB 2 .cmdtabset 3 \
	.menufr.switchmenu 38 .cmdtabset.indexclu.indexclufr.indexcludirentry \
	21 .cmdtabset.build.buildtagfr.entertag 40 \
...
proc cmd {{base .cmd} args} {
	...
	entry $base$w(32) -highlightbackground "lightgray"\
		-insertbackground "black" -selectbackground "lightblue"\
		-selectborderwidth "0" -selectforeground "black"\
		-textvariable "cmdArray(indexche,start)" -width "10";
	label $base$w(33) -anchor "w" -borderwidth "0"\
		-highlightbackground "lightgray";
	entry $base$w(34) -highlightbackground "lightgray"\
		-insertbackground "black" -selectbackground "lightblue"\
		-selectborderwidth "0" -selectforeground "black"\
		-textvariable "cmdArray(indexche,last)" -width "10";
