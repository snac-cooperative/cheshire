 ...
 *
 *	$Id: db_win32.h,v 1.2 2000/08/31 18:35:56 ray Exp $
 */
...
#define	DB_DBT_DUPOK	0x020		/* Insert if duplicate. */
	...
	void	 *app_private;		/* Key/data application private_var. */
};
...
#define	DB_VERB_WAITSFOR	0x0008	/* Dump waits-for table. */
	...
	void	*cj_internal;		/* C++/Java private_var. */
...
#define	DB_ENV_DBLOCAL		0x00004	/* DB_ENV allocated for private_var DB. */
...
/* DB (private_var) error return codes. */
...
#define	DB_LOGFILEID_INVALID	-1
	...
	void	*bt_internal;		/* Btree/Recno access method private_var. */
	void	*cj_internal;		/* C++/Java private_var. */
	void	*h_internal;		/* Hash access method private_var. */
	void	*q_internal;		/* Queue access method private_var. */
	void	*xa_internal;		/* XA private_var. */
...
struct __dbc {
	...
	DBC_INTERNAL *internal;		/* Access method private_var. */
 ...
 * to a new_var log file before the maximum length imposed by an unsigned 4-byte
 * offset is reached.
 */
struct __db_lsn {
...
#define	DB_MPOOL_NEW		0x004	/* Create a new_var page. */
