...
#                  Ray Larson -- added file browse and dump features
...
button .controls.forwards -relief raised -font $buttonFont -text "FORWARD" \
    -command "changeRec f"
button .controls.dump -relief raised -font $buttonFont -text "DUMP ALL RECS" \
    -command "dumpAllRecs"
...
pack .controls.backwards .controls.current .controls.record \
	.controls.forwards .controls.dump -in .controls -side left -expand 1
