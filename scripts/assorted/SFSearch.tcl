...
ALIGN=left>University of Liverpool Science Fiction Archive: \
...
if {$servername != "UCBDL" && $servername != "CSMP" && $servername != "SF"} {
    if {$INFOBUS} {
...
if {$nextrec <= $hits} {
    puts "<HR>"
    puts "<FORM \
ACTION=\"/cgi-bin/SFSearch.tcl\" METHOD=POST>"
