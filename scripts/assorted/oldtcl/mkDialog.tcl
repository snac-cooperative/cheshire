# ************************************************************************
#
#       Program Name:   mkDialog.tcl
#
#       Programmer:     Sandia Hsu, Sui-hwai Hwang
#
#       Purpose:	Create a dialog box with a message and any number
...
# }
    ...
    wm title $w "Confirm Box"
    wm iconname $w "Confirm Box"

	global curdir prevdir
