...
#set env(QUERY_STRING) "server=GLAS&boolean=and&field1idx=topic&field1cont=john&field2idx=author&field2cont=&field3idx=title&field3cont=&maxrecs=10&firstrec=1&format=html"
...
# to test.
set sourcestring "server=GLAS&boolean=and&field1idx=topic&field1cont=john&field2idx=author&field2cont=&field3idx=title&field3cont=&maxrecs=10&firstrec=1&format=html"
