...
proc check_new_file {} {
	...
	puts stdout "  -- starting new file $newfilename"
...
proc print_jstoc_file {} {
    ...
    set htmlpath "http://sca.lib.liv.ac.uk/ead/htmldev/"
...
\n\
<base href =\"http://sca.lib.liv.ac.uk/ead/htmldev/\"> \n\
  </head>\n\
 <frameset rows= 90%,*>\n\
  <FRAMESET COLS=\"45%,*\">\n\
...
#---------- End of Subroutines ----------
	...
	set ignoretags {TITLEPAGE FRONTMATTER DID ARCHDESC EXTENT PERSNAME GEOGNAME CORPNAME PLACENAME EVENT LANGUAGE LISTHEAD NOTESTMT TITLESTMT PHYSFACET DROW DENTRY TSPEC}
...
while {$cont} {
    ...
    puts stdout "Starting to process $toc_eadid id: $cont"
