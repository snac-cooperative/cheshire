...
# Verified on /both/ calls to a function, if relevant.

# XXX -- activity requires clustering! (or stupid large searches)
...
proc function_activity {} {
    global indata current_user_info

    if {![maybe_throw_reqform "" "System"] } {
	set types $indata(arg1)

	puts "No cluster information yet!"
