...
proc validate_and_save {record key title} {
    global indata CHESHIRE_ROOT_DATA CHESHIRE_ROOT CHESHIRE_PATH CGI_ROOT REBUILD_SCRIPT_DATA REBUILD_LEVEL_DATA current_document_info E_REBUILD
	...
	throwfile "err.html" [list "\%ERR\% $E_MKDIR"]
    } else {
